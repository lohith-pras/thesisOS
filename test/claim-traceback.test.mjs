...
function stateWithGroundedNote() {
  ...
  state.evidence = [{ feedbackThreadId: "feedback-1", taskId: "task-literature", sourceId: "group:123:ABCD", title: "Evidence-backed revision", doi: "10.1000/example", selectedAt: "2026-07-14T00:00:00.000Z", draft: { provider: "deterministic-template", sourceNotes: [{ sourceId: "group:123:ABCD", summary: "The paper supports a transparent revision trail.", relevance: "Use it to ground the chapter revision." }] } }];
  return state;
}
